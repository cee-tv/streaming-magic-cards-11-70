  ...
  return (
    <div className="relative h-[50vh] md:h-[70vh] mb-8">
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-[#1A1F2C] via-netflix-black/25 to-transparent" />
        <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-[#1A1F2C] to-transparent" />
      </div>
