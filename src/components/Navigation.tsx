              ...
              <form onSubmit={handleSearch} className="flex items-center">
                <div className="relative w-full">
                  ...
                  <input
                    ...
                    className="w-full bg-black/50 text-sm text-white border border-white/10 rounded-full pl-8 pr-4 py-1 placeholder:text-gray-400 focus:outline-none focus:border-white/30"
                  />
                </div>
              </form>
            </div>
